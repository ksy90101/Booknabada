...
<body>
	...
	<div class="boardDetailPart">
		<div id="list" style="height: 60px;">
			<div id="listbox" style="width: 10%; font-weight: bold">글번호 : ${freeDetail.board_no }</div>
			<div id="listbox" style="width: 40%; font-weight: bold">글쓴이 : ${freeDetail.user_name }</div>
			<div id="listbox" style="width: 30%; font-weight: bold">날짜 : ${freeDetail.board_date }</div>
			<div id="listbox" style="width: 20%; font-weight: bold">카운트 : ${freeDetail.board_count }</div>

		</div>

		<div id="list" style="height: 90px;">
			<div id="title">제목</div>
			<div id="listbox" style="width: 100%; font-weight: bold;">${freeDetail.board_title }</div>
		</div>
		<div id="list" style="height: 60px;">
			<div id="title">내용</div>
