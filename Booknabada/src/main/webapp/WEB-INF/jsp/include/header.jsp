...
<header id="header">
	<div class="inner-wrap">
		<ul class="left cf">
			<li class="hamberger_btn"><img
				src="../images/hamburger-menu.png" alt="menu"></li>
			<li class="search_box">
				<form action="../book/searchbooklist.do" method="post">
					<img src="../images/search.png" alt="search"> <input
						type="text" name="search" placeholder="필요하신 책을 검색해보세요">
				</form>
			</li>
		</ul>
		<h1 class="logo">
			<a href="../index/index.do"> <img src="../images/logo.png"
				alt="BOOKNABADA">
			</a>
		</h1>
		<ul class="right cf">
			<li class="alert"><img src="../images/alert.png" alt="알림">
			</li>
			<li class="mypage"><c:choose>
					<c:when test="${sessionScope.id eq null }">
						<a href="#" class="openMask"> <img src="../images/mypage.png"
							alt="마이페이지">
						</a>
					</c:when>
					<c:otherwise>
						<a href="../my/myhome.do"> <img src="../images/mypage.png"
							alt="마이페이지">
						</a>
					</c:otherwise>
				</c:choose></li>
			<c:choose>
				<c:when test="${sessionScope.id eq null }">
					<li class="login"><a href="#" class="openMask"><img
							src="../images/login.png" alt="로그인"></a></li>
				</c:when>
				<c:otherwise>
					<li class="logout"><a href="../login/logout.do"> <img
							src="../images/logout.png" alt="로그아웃">
					</a>
				</c:otherwise>
			</c:choose>
		</ul>
