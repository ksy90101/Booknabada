...
//				
	...
	HttpSession session = request.getSession();
	  ...
	  @RequestMapping(value = "notice/noticeWriteAction.do") public ModelAndView
	  writeAction(HttpServletRequest request, @RequestParam("file") MultipartFile file) throws Exception {
